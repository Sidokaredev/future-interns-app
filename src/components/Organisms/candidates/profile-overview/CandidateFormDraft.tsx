...
export default function CandidateFormDraft({
  formValue,
  setFormValue,
  errMsg,
  onSubmit,
          ...
          <Box
            ...
            src={
              filePreview["background_profile_img"] ? filePreview["background_profile_img"].src :
                (typeof formValue.background_profile_img === "string") ? `http://localhost:3000${formValue.background_profile_img}?t=${new Date(Date.now()).getTime()}` :
            ...
            <Avatar
              ...
              src={
                filePreview["profile_img"] ? filePreview["profile_img"].src :
                  (typeof formValue.profile_img === "string") ? `http://localhost:3000${formValue.profile_img}?t=${new Date(Date.now()).getTime()}` :
