...
export default function ReadThroughTestPage() {
  /* react-router */
  ...
  /* state */
  const [readThroughLogs, setReadThroughLogs] = useState<{
    chart: {
  ...
  const RunReadThroughScenario = async () => {
    ...
    const logHeaders = new Headers({
      "Authorization": "Bearer " + token,
      "X-Measure-Cache-Request-Logs": "read-through",
  ...
  useEffect(() => {
    (async () => {
      ...
      if (data) {
        return setReadThroughLogs(data);
      };
    })();
  }, [refetch]);
  return (
          ...
          >
            <Grid item xs={6}>
              ...
              >
                <Bar
                  data={{
                    ...readThroughLogs.chart.cache_status,
                    datasets: [
                      {
                        ...readThroughLogs.chart.cache_status.datasets[0],
                        minBarLength: 10,
                      }
                    ]
                  }}
            ...
            <Grid item xs={6}>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Tooltip title="Next Logs" placement="bottom-end">
                      <IconButton size="small"
                        disabled={chunkNumber === (Math.ceil(readThroughLogs.chart.resource_utils.datasets[0].data.length / 10))}
                        onClick={() => {
                          setChunkNumber(prev => prev + 1);
                        }}
                      >
                ...
                <Line
                  data={{
                    ...readThroughLogs.chart.resource_utils,
                    labels: chunkedLabels,
                    datasets: [
                      {
                        ...readThroughLogs.chart.resource_utils.datasets[0],
                        data: chunkedRespTime,
                        backgroundColor: green[200],
                        borderColor: green[400]
                      },
                      {
                        ...readThroughLogs.chart.resource_utils.datasets[1],
                        data: chunkedResUtil,
            ...
            <TableContainer>
              <Table size="small">
                ...
                <TableBody>
                  ...
                  {paginatedReadThroughLogs.map((log_, index) => (
                    <TableRow hover>
                      <TableCell>
